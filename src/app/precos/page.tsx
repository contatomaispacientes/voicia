...
const faqs = [
  ...
  { q: "Como funciona a cobrança?", a: "A cobrança é mensal ou anual (com desconto de 16%). Você pode cancelar a qualquer momento sem multa ou taxa de cancelamento." },
            ...
            <div className="max-w-3xl mx-auto text-center p-animate">
              <div className="p-header">
                ...
                <div className="inline-flex items-center gap-3 rounded-full border border-white/[0.08] bg-[#0E1725] p-1">
                  ...
                  >
                    Anual
                    <span className="text-[10px] bg-white/20 px-1.5 py-0.5 rounded-full">-16%</span>
                  </button>
                </div>
              </div>
            </div>
